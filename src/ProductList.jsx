...
import { addItem } from './CartSlice'; // Ensure this file exists and exports addItem
...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        ...
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Mark the specific product as added
        }));
    };
                    ...
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            ...
                            <div className="product-list">
                                {/* Map through the plants within each category */}
